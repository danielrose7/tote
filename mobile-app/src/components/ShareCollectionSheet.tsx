					...
					{!isPublished ? (
						<View style={styles.section}>
							<Text style={styles.description}>
								Make this collection publicly viewable — anyone with the link
								can browse your picks.
							</Text>
							<TouchableOpacity
									...
									<View style={styles.inlineEditActions}>
										{!isDefaultSlug ? (
											<TouchableOpacity
												...
												onPress={handleResetSlug}
											>
												<Text style={styles.slugResetBtnText}>
													Reset to default
												</Text>
											</TouchableOpacity>
										) : null}
										...
										<TouchableOpacity
											...
											onPress={() => {
												setSlugInput(
													collection.collectionData?.slug ?? defaultSlug,
												);
												setEditingSlug(false);
											}}
										>
