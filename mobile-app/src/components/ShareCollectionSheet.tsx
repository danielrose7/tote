...
export function ShareCollectionSheet({ collection, visible, onClose }: Props) {
  ...
  const shareUrl = publication?.username
    ? `https://tote.tools/s/${publication.username}/${publication.slug}`
    : null;
  ...
  function handleRemoveMember(member: CollectionMember) {
    Alert.alert('Remove member', `Remove this member from the collection?`, [
      { text: 'Cancel', style: 'cancel' },
      {
        text: 'Remove',
        style: 'destructive',
              ...
              <View style={styles.section}>
                {!isPublished ? (
                  ...
                  <>
                          ...
                          {shareUrl && (
                            ...
                            >
                              <Ionicons
                                ...
                                color="#6366f1"
                              />
                              <Text style={styles.inlineEditText}>
                                Edit URL
                              </Text>
                            </TouchableOpacity>
                          )}
                    ...
                    {!editingSlug && !shareUrl && (
                      <TouchableOpacity
                        style={styles.noUsernameCallout}
                        onPress={() =>
                          Linking.openURL('https://tote.tools/settings')
                        }
                      >
                        <Ionicons
                          ...
                          color="#92400e"
                        />
                        <View style={styles.noUsernameText}>
                          <Text style={styles.noUsernameTitle}>
                            Username required
                          </Text>
                          <Text style={styles.noUsernameDesc}>
                            Add a username in Settings to get a shareable link.
                          </Text>
                        </View>
                        <Ionicons
                          name="open-outline"
...
const styles = StyleSheet.create({
  ...
  noUsernameText: { flex: 1, gap: 2 },
  noUsernameTitle: { fontSize: 13, fontWeight: '600', color: '#92400e' },
  noUsernameDesc: { fontSize: 12, color: '#b45309', lineHeight: 17 },
