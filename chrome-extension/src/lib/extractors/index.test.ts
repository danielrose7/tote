...
describe("Collection Page Extraction", () => {
	beforeEach(() => {
		setUrl("/collections/test-products");
	});

	it("extracts repeated product cards from collection pages", () => {
		setupDOM(`
      <main>
        <div class="grid-product product-card">
          <a href="/collections/test-products/products/linen-hat" class="grid-product__link">
            <img src="https://example.com/linen-hat.jpg" alt="Linen Hat">
            <div class="grid-product__title">Linen Hat</div>
            <div class="grid-product__price">$42.00</div>
          </a>
        </div>
        <div class="grid-product product-card">
          <a href="/collections/test-products/products/cotton-tote" class="grid-product__link">
            <img src="https://example.com/cotton-tote.jpg" alt="Cotton Tote">
            <div class="grid-product__title">Cotton Tote</div>
            <div class="grid-product__price">$68</div>
          </a>
        </div>
      </main>
    `);
		...
		expect(result.collectionItems?.[0]).toMatchObject({
			title: "Linen Hat",
			price: "42.00",
			currency: "USD",
			url: "http://localhost:3000/collections/test-products/products/linen-hat",
			imageUrl: "https://example.com/linen-hat.jpg",
		});
		expect(result.collectionItems?.[1]).toMatchObject({
			title: "Cotton Tote",
			price: "68",
		});
	});

	it("deduplicates buy and explore links for the same tile by title and price", () => {
		setupDOM(`
      <section class="product-tile">
        <h2><a href="/p/st-go-libelle-4.html">Libelle</a></h2>
        <p>The Libelle stroller has one of the world's smallest compact folds.</p>
        <ul><li>Ultra-compact Fold</li><li>Ultra-lightweight</li></ul>
        <span class="price">$254.96</span>
        <a href="/p/st-go-libelle-4.html">Buy</a>
        <a href="/libelle-gold-stroller.html">Explore</a>
      </section>
      <section class="product-tile">
        <h2><a href="/p/st-go-beezy.html">Beezy</a></h2>
        <p>A handy city stroller that's ready to use from birth.</p>
        <span class="price">$449.95</span>
        <a href="/p/st-go-beezy.html">Buy</a>
      </section>
    `);
		...
		expect(result.pageType).toBe("collection");
		expect(result.collectionItems?.map((item) => item.title)).toEqual([
			"Libelle",
			"Beezy",
		]);
		expect(result.collectionItems?.[0].url).toBe(
			"http://localhost:3000/p/st-go-libelle-4.html",
		);
		expect(result.collectionItems?.[0].description).toContain(
			"Ultra-compact Fold",
		);
	});

	it("does not expand related products on product pages", () => {
		setUrl("/collections/test-products/products/main-product");
		document.head.innerHTML = `
    ...
    `;
      ...
      <section class="related-products">
        <div class="product-card">
          <a href="/collections/test-products/products/related-one">
            <span class="title">Related One</span>
            <span class="price">$20</span>
          </a>
        </div>
        <div class="product-card">
          <a href="/collections/test-products/products/related-two">
            <span class="title">Related Two</span>
    ...
    `;
		...
		expect(result.collectionItems).toBeUndefined();
	});
});
...
describe("DOM Image Gallery Extraction", () => {
	beforeEach(() => {
		document.head.innerHTML = "";
		document.body.innerHTML = "";
		Object.defineProperty(window, "location", {
	...
	it("uses og:image as anchor to find gallery siblings", () => {
		document.head.innerHTML = `
			<meta property="og:image" content="https://cdn.example.com/img1.jpg">
		`;
		document.body.innerHTML = `
			<div class="product-gallery">
				<img src="https://cdn.example.com/img1.jpg" alt="Product 1">
				<img src="https://cdn.example.com/img2.jpg" alt="Product 2">
				<img src="https://cdn.example.com/img3.jpg" alt="Product 3">
			</div>
		`;
		const result = extractMetadata();
		...
		expect(result.images).toContain("https://cdn.example.com/img3.jpg");
	});

	it("extracts from Shopify media-gallery container", () => {
		document.body.innerHTML = `
			<media-gallery role="region" aria-label="Gallery Viewer">
				<img src="https://cdn.shopify.com/s/files/product1.jpg" alt="Product">
				<img src="https://cdn.shopify.com/s/files/product2.jpg" alt="Product">
				<img src="https://cdn.shopify.com/s/files/product3.jpg" alt="Product">
			</media-gallery>
		`;
		const result = extractMetadata();
		expect(result.images).toBeDefined();
	...
	it("extracts from swiper carousel with data-src lazy loading", () => {
		document.body.innerHTML = `
			<div class="swiper-wrapper">
				<div class="swiper-slide"><img data-src="https://cdn.example.com/lazy1.jpg" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="></div>
				<div class="swiper-slide"><img data-src="https://cdn.example.com/lazy2.jpg" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="></div>
				<div class="swiper-slide"><img data-src="https://cdn.example.com/lazy3.jpg" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="></div>
			</div>
		`;
		const result = extractMetadata();
		expect(result.images).toBeDefined();
		expect(result.images?.length).toBe(3);
		expect(result.images?.[0]).toBe("https://cdn.example.com/lazy1.jpg");
	});

	it("deduplicates slick cloned slides", () => {
		document.body.innerHTML = `
			<div class="slick-list">
				<div class="slick-track">
					<div class="slick-slide"><img src="https://cdn.example.com/a.jpg"></div>
					<div class="slick-slide"><img src="https://cdn.example.com/b.jpg"></div>
					<div class="slick-cloned"><img src="https://cdn.example.com/a.jpg"></div>
					<div class="slick-cloned"><img src="https://cdn.example.com/b.jpg"></div>
				</div>
			</div>
		`;
		const result = extractMetadata();
	...
	it("picks largest image from srcset", () => {
		document.body.innerHTML = `
			<div class="product-gallery">
				<img srcset="https://cdn.example.com/sm.jpg 300w, https://cdn.example.com/md.jpg 600w, https://cdn.example.com/lg.jpg 1200w" src="https://cdn.example.com/sm.jpg">
				<img srcset="https://cdn.example.com/sm2.jpg 300w, https://cdn.example.com/lg2.jpg 1200w" src="https://cdn.example.com/sm2.jpg">
			</div>
		`;
		const result = extractMetadata();
		expect(result.images).toBeDefined();
		expect(result.images).toContain("https://cdn.example.com/lg.jpg");
		expect(result.images).toContain("https://cdn.example.com/lg2.jpg");
	});

	it("deduplicates CDN size variants", () => {
		document.body.innerHTML = `
			<div class="product-gallery">
				<img src="https://cdn.shopify.com/s/files/product_grande.jpg">
				<img src="https://cdn.shopify.com/s/files/product_master.jpg">
				<img src="https://cdn.shopify.com/s/files/other_grande.jpg">
			</div>
		`;
		const result = extractMetadata();
		expect(result.images).toBeDefined();
	...
	it("excludes logos and icons", () => {
		document.body.innerHTML = `
			<main>
				<img src="https://cdn.example.com/logo.png" width="200" height="200">
				<img src="https://cdn.example.com/favicon.ico" width="200" height="200">
				<img src="//harvestandmill.com/cdn/shop/files/Harvest_and_Mill_Logo_Original_5_620x.png?v=1652737301" itemprop="logo" alt="Harvest &amp; Mill" width="620" height="200">
				<img src="https://cdn.example.com/product-front.jpg" width="800" height="800">
				<img src="https://cdn.example.com/product-back.jpg" width="800" height="800">
			</main>
		`;
		const result = extractMetadata();
		expect(result.images).toBeDefined();
		...
		expect(result.images).toContain("https://cdn.example.com/product-back.jpg");
	});

	it("finds large images in main as heuristic fallback", () => {
		document.body.innerHTML = `
			<main>
				<div>
					<img src="https://cdn.example.com/hero.jpg" width="600" height="600">
					<img src="https://cdn.example.com/detail.jpg" width="600" height="600">
				</div>
			</main>
		`;
		const result = extractMetadata();
	...
	it("returns no images array when only one image found", () => {
		document.body.innerHTML = `
			<main>
				<img src="https://cdn.example.com/only-one.jpg" width="600" height="600">
			</main>
		`;
		const result = extractMetadata();
