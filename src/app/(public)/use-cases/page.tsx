...
export const metadata: Metadata = {
	...
	openGraph: {
		title:
			"Organize Wishlists, Renovation Projects, and Design Inspiration — Tote",
		description:
			"See how people use Tote to organize shopping — from holiday gift lists and home renovations to wardrobe planning and professional design sourcing.",
	},
};
...
function HouseIcon() {
	return (
		<svg className={styles.cardIcon} viewBox="0 0 48 48" aria-hidden="true">
			<path
				d="M24 6 L42 22 L42 42 L6 42 L6 22 Z"
				fill="var(--card-accent)"
				opacity="0.5"
			/>
			<rect
...
function HangerIcon() {
	return (
		<svg className={styles.cardIcon} viewBox="0 0 48 48" aria-hidden="true">
			...
			/>
			<path
				d="M24 14 L24 18 L42 32 L42 36 L6 36 L6 32 L24 18"
				fill="var(--card-accent)"
				opacity="0.4"
				stroke="var(--card-accent)"
				strokeWidth="1.5"
	...
	return (
		<article className={styles.article}>
			...
			<p className={styles.lead}>
				From gift lists to renovation projects, Tote keeps your finds organized
				across every store you shop.
			</p>
			...
			{useCases.map((uc) => {
				...
				return (
					<div
						...
						style={{ "--card-accent": uc.accent } as React.CSSProperties}
					>
