...
async function resolveCollection(
  username: string,
  slug: string
): Promise<{ collectionId: string; collectionName?: string; collectionDescription?: string } | null> {
  ...
  const publishedCollections =
    user.public_metadata?.publishedCollections as
      | Record<string, string | { id: string; name?: string; description?: string }>
      | undefined;
...
export async function generateMetadata(props: {
  ...
  const description = result.collectionDescription
