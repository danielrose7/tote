...
const sourceCategories = ["Major retailers", "Indie shops", "Anywhere online"];
			...
			<main>
				<section className={styles.hero}>
					<div className={styles.heroCopy}>
						...
						<h1 className={styles.heroTitle}>
							Save anything you might buy — from any store.
						</h1>
					...
					<div className={styles.heroVisual}>
						<div className={styles.floatingBadgeTop}>
							One collection across every store
						</div>
						<div className={styles.floatingBadgeBottom}>
							Refresh prices, track budgets, and narrow the shortlist
						</div>
				...
				>
					...
					<div className={styles.sourceCategories}>
						{sourceCategories.map((category) => (
							<span key={category} className={styles.sourceCategory}>
								{category}
							</span>
						))}
					</div>
					<div className={styles.sourcePills}>
						{sourceStores.map((store) => (
							<span key={store} className={styles.sourcePill}>
								{store}
							</span>
						))}
					</div>
				...
				<section id="use-cases" className={styles.showcaseSection}>
					<div className={styles.showcaseCopy}>
						...
						<h2 className={styles.sectionTitle}>
							One place to compare, shortlist, and decide.
						</h2>
						<p className={styles.sectionBody}>
							When a project spans five stores, saving links is the easy part.
							Keeping them useful later is harder. Tote gives you one place to
						...
						<div className={styles.useCaseGrid}>
							{useCases.map((useCase) => (
								<Link
									...
									style={
										{
											"--use-case-accent": useCase.accent,
				...
				<section className={styles.principlesSection}>
					<div className={styles.sectionIntro}>
						...
						<h2 className={styles.sectionTitle}>
							Built for the messy middle between finding something and buying
							it.
						</h2>
					</div>
				...
				<section id="comparison" className={styles.comparisonSection}>
					<div className={styles.sectionIntro}>
						...
						<h2 className={styles.sectionTitle}>
							Most tools help you save. Tote helps you finish the decision.
						</h2>
						<p className={styles.sectionBody}>
							Bookmarks, store wishlists, spreadsheets, and group chats each
							help with one piece of the job. Tote keeps the options, price
							checks, budget, shortlist, and sharing in the same place.
						</p>
					</div>
					<div className={styles.comparisonScroller}>
						<div className={styles.comparisonMatrix}>
							<div
								className={`${styles.matrixCell} ${styles.matrixCorner}`}
								aria-hidden="true"
							/>
							...
							{comparisonRows.map((row) => (
								<Fragment key={row.feature}>
									<div
										className={`${styles.matrixCell} ${styles.matrixFeature}`}
									>
										{row.feature}
									</div>
									{comparisonColumns.map((column) => {
										...
										return (
											...
											>
												<span
													className={
														value ? styles.matrixCheck : styles.matrixOmission
													}
												>
													{value ? "✓" : "—"}
												</span>
				...
				<section id="audiences" className={styles.audienceSection}>
					<div className={styles.sectionIntro}>
						...
						<h2 className={styles.sectionTitle}>
							Built for the way you save before you buy.
						</h2>
					</div>
				...
				<section id="privacy" className={styles.privacySection}>
					<div className={styles.privacyPanel}>
						...
						<h2 className={styles.sectionTitle}>
							Tote respects the fact that your shopping life is yours.
						</h2>
						<p className={styles.sectionBody}>
