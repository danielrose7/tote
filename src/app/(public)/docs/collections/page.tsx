...
export default function CollectionsPage() {
  return (
    <article className={styles.article}>
      ...
      <AnchorHeading as="h2" id="what-is-a-collection">What is a Collection?</AnchorHeading>
      <p>
      ...
      <AnchorHeading as="h2" id="creating-a-collection">Creating a Collection</AnchorHeading>
      <p>
      ...
      <AnchorHeading as="h2" id="collection-features">Collection Features</AnchorHeading>
      <AnchorHeading as="h3" id="colors">Colors</AnchorHeading>
      <p>
      ...
      <AnchorHeading as="h3" id="view-modes">View Modes</AnchorHeading>
      <p>
      ...
      <AnchorHeading as="h3" id="budget-tracking">Budget Tracking</AnchorHeading>
      <p>
      ...
      <AnchorHeading as="h2" id="default-collection">Default Collection</AnchorHeading>
      <p>
      ...
      <AnchorHeading as="h2" id="item-count-badges">Item Count Badges</AnchorHeading>
      <p>
      ...
      <AnchorHeading as="h2" id="deleting-a-collection">Deleting a Collection</AnchorHeading>
      <p>
      ...
      <AnchorHeading as="h2" id="reordering-collections">Reordering Collections</AnchorHeading>
      <p>
      ...
      <AnchorHeading as="h2" id="collections-vs-slots">Collections vs. Slots</AnchorHeading>
      <p>
      ...
      <AnchorHeading as="h3" id="faq-how-many-collections">How many collections can I have?</AnchorHeading>
      <p>
        There's no limit. Create as many collections as you need — one per project, season, room, or any theme that makes sense to you.
      </p>

      <AnchorHeading as="h3" id="faq-move-products">Can I move products between collections?</AnchorHeading>
      <p>
      ...
      <AnchorHeading as="h3" id="faq-delete-collection">What happens when I delete a collection?</AnchorHeading>
      <p>
