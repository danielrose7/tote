  ...
  return (
    <article className={styles.article}>
      ...
      <p>
        ...
        use to join. Once someone joins your shared collection, they can view
        all the products and add their own.
      </p>
      ...
      <AnchorHeading as="h2" id="what-collaborators-can-do">
        What Collaborators Can Do
      </AnchorHeading>
      <p>Everyone with access to a shared collection can:</p>
      <ul>
        <li>
          <strong>View all products</strong> — see everything in the collection
        </li>
        <li>
          <strong>Add new products</strong> — contribute their own finds
        </li>
        <li>
          <strong>Create slots</strong> — organize products into groups
        </li>
        <li>
          <strong>Refresh prices</strong> — update product information
        </li>
      </ul>
      ...
      <p>
        It depends on the role you assign. When creating an invite link, you
        choose whether collaborators can view only, edit (add and modify
        products), or have full admin access. See{' '}
        <a href="/docs/collections">Collections</a> for more on managing your
        collections.
      </p>
      ...
      <p>
        For public links, open the Share dialog and click &quot;Make
        Private&quot; to revoke access immediately. For invite-based sharing,
        collaborators who have already joined retain access — this is a
        collaborative relationship, not a view-only broadcast.
      </p>
            ...
            mainEntity: [
              {
                ...
                acceptedAnswer: {
                  '@type': 'Answer',
                  text: 'It depends on the role you assign. When creating an invite link, you choose whether collaborators can view only, edit, or have full admin access.',
                },
              },
              {
                '@type': 'Question',
              ...
              },
              {
                ...
                acceptedAnswer: {
                  '@type': 'Answer',
                  text: 'For public links, open the Share dialog and click "Make Private" to revoke access immediately. For invite-based sharing, collaborators who have already joined retain access.',
                },
              },
              {
                '@type': 'Question',
                ...
                acceptedAnswer: {
                  '@type': 'Answer',
                  text: 'Yes! When you publish a collection, Tote creates a short link from the collection name. You can change it in the Share dialog to whatever you like.',
                },
              },
            ],
          }),
