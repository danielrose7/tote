...
export default function ExtensionPage() {
  return (
    <article className={styles.article}>
      ...
      <AnchorHeading as="h2" id="installing-the-extension">Installing the Extension</AnchorHeading>
      <ol>
      ...
      <AnchorHeading as="h2" id="signing-in">Signing In</AnchorHeading>
      <p>
      ...
      <AnchorHeading as="h2" id="saving-a-product">Saving a Product</AnchorHeading>
      <p>
        There are two ways to save a product:
      </p>

      <AnchorHeading as="h3" id="one-click-save">One-Click Save</AnchorHeading>
      <ol>
      ...
      <AnchorHeading as="h3" id="right-click-context-menu">Right-Click Context Menu</AnchorHeading>
      <p>
      ...
      <AnchorHeading as="h2" id="choosing-a-collection-and-slot">Choosing a Collection and Slot</AnchorHeading>
      <p>
      ...
      <AnchorHeading as="h2" id="what-gets-captured">What Gets Captured</AnchorHeading>
      <p>
      ...
      <AnchorHeading as="h2" id="supported-stores">Supported Stores</AnchorHeading>
      <p>
      ...
      <AnchorHeading as="h2" id="troubleshooting">Troubleshooting</AnchorHeading>
      <AnchorHeading as="h3" id="extension-not-showing-product-details">Extension not showing product details</AnchorHeading>
      <p>
      ...
      <AnchorHeading as="h3" id="not-signed-in">Not signed in</AnchorHeading>
      <p>
      ...
      <AnchorHeading as="h3" id="faq-firefox-safari">Does Tote work on Firefox or Safari?</AnchorHeading>
      <p>
      ...
      <AnchorHeading as="h3" id="faq-pin-extension">How do I pin the Tote extension to my toolbar?</AnchorHeading>
      <p>
      ...
      <AnchorHeading as="h3" id="faq-save-without-popup">Can I save products without opening the popup?</AnchorHeading>
      <p>
