...
export default function GettingStartedPage() {
  return (
    <article className={styles.article}>
      ...
      <AnchorHeading as="h2" id="1-create-your-account">1. Create Your Account</AnchorHeading>
      <p>
      ...
      <AnchorHeading as="h2" id="2-install-the-browser-extension">2. Install the Browser Extension</AnchorHeading>
      <p>
        The browser extension is the fastest way to save products. <a href={CHROME_WEB_STORE_URL} target="_blank" rel="noopener noreferrer">Install it from the Chrome Web Store</a> — it works on Chrome, Edge, Brave, and Arc. Then sign in with the same account you just created.
      </p>
      <p>
        See the <a href="/docs/extension">Browser Extension guide</a> for detailed setup instructions.
      </p>

      <AnchorHeading as="h2" id="3-save-your-first-product">3. Save Your First Product</AnchorHeading>
      <p>
      ...
      <AnchorHeading as="h2" id="4-organize-with-collections">4. Organize with Collections</AnchorHeading>
      <p>
      ...
      <AnchorHeading as="h2" id="5-keep-shopping">5. Keep Shopping</AnchorHeading>
      <p>
      ...
      <AnchorHeading as="h2" id="next-steps">Next Steps</AnchorHeading>
      <ul>
      ...
      <AnchorHeading as="h3" id="faq-is-tote-free">Is Tote free?</AnchorHeading>
      <p>
        Yes. Tote is free to use — create an account, install the extension, and start saving products at no cost.
      </p>

      <AnchorHeading as="h3" id="faq-what-stores">What stores does Tote work with?</AnchorHeading>
      <p>
      ...
      <AnchorHeading as="h3" id="faq-need-extension">Do I need the browser extension?</AnchorHeading>
      <p>
        No. The extension makes saving products faster (one click) and works on Chrome, Edge, Brave, and Arc, but you can also add products manually by pasting a URL in the web app. See <a href="/docs/adding-links">Adding Links</a> for details.
      </p>

      <AnchorHeading as="h3" id="faq-mobile">Does Tote work on my phone?</AnchorHeading>
      <p>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          "mainEntity": [
            ...
            { "@type": "Question", "name": "Do I need the browser extension?", "acceptedAnswer": { "@type": "Answer", "text": "No. The extension makes saving products faster (one click) and works on Chrome, Edge, Brave, and Arc, but you can also add products manually by pasting a URL in the web app." } },
