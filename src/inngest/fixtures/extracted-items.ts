 ...
 */
export const MOCK_EXTRACTED_ITEMS: Record<string, Omit<ExtractedItem, "sourceUrl">> = {
	...
	"https://earthmamaorganics.com/products/simply-non-scents-castile-baby-wash": {
		...
		brand: "Earth Mama",
		availability: "in stock",
		imageUrl: "https://earthmamaorganics.com/cdn/shop/products/castile-baby-wash.jpg",
	},
