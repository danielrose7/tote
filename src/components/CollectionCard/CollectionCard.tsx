...
export function CollectionCard({
  ...
  return (
    <article
      ...
      style={{ '--collection-color': hex } as React.CSSProperties}
    >
      <div className={styles.cover}>
        {previewImages.length > 0 ? (
          ...
          <div
            ...
            style={{
              background: `radial-gradient(circle at 20% 80%, ${hex}99 0%, transparent 55%),
                           radial-gradient(circle at 80% 15%, ${hex}66 0%, transparent 45%),
                           radial-gradient(circle at 55% 50%, ${hex}44 0%, transparent 60%),
                           ${hex}22`,
            }}
          >
            <svg
