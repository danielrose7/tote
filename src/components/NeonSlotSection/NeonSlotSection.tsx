          ...
          >
            ...
            {items.length === 0 ? (
              ...
              >
                ...
                >
                  This section has {items.length}{' '}
                  {items.length === 1 ? 'item' : 'items'}. What should happen to
                  them?
                </p>
                <label
                  style={{
                ...
                >
                  ...
                  {items.length === 1 ? 'item' : 'items'} from the collection
                </label>
                <label
                  style={{
                    display: 'flex',
                  ...
                  >
                    <input
                      ...
                      onChange={() => {
                        ...
                        if (!moveToSectionId)
                          setMoveToSectionId(otherSections[0].id);
                      }}
                    />
